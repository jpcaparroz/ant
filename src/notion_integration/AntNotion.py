...
class AntNotion():
    ...
    async def get_database_page_ids(self, database_id: str) -> List[str]:
    ...
    async def delete_pages(self, database_id: str) -> None:
        ...
        page_ids: list = await self.get_database_page_ids(database_id)
        if not page_ids:
