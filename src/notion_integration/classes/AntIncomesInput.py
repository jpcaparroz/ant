...
DATABASE_ID: str = get_env('NOTION_DATABASE_ANT_INCOMES_INPUT_ID')
DATE_FORMAT: str = '%Y-%m-%d'


class AntIncomesInput():
    """Incomes Input class representation
    """
    ...
    @classmethod
    def from_json(cls, ant_as_json: str) -> 'AntIncomesInput':
    ...
    @classmethod
    def from_dict(cls, ant_as_dict: Dict) -> 'AntIncomesInput':
        """ Alternative constructor
